...
- Learn state management between server and client
- Learn to build fullstack app

## Future Plans

- Auth system. User needs to login before start the quiz
- Shuffling of questions and options for each attempt
- Show quiz based on difficulty level
